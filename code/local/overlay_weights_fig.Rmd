...
resamp_sec_weights_fig <- ggplot() +
  geom_tile(data = cropland_table_crop, mapping = aes(x = x, y = y, fill = weight), size = 2, color = grid_color) +
   geom_sf(data = county, alpha = 0) +
...
admin_region_fig <- 
  ...
  geom_tile(data = cropland_table_crop, mapping = aes(x = x, y = y), alpha = 0, size = 2, color = grid_color) +
  theme_void() +
...
weight_area_fig <-
  ggplot() +
  geom_tile(data = overlay, mapping = aes(x = x, y = y, fill = w_area), size = 2, color = grid_color) +
  scale_fill_gradient(low = "white",
                      high = w_area_fill,

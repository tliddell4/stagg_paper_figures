...
ggsave(cropland_fig,
       ...
       filename = here("figs/reproduce-test/overlay_weights_fig/raster_fig.pdf"),
       width = 5,
       height = 5,
       units = "in")
ggsave(cropland_fig,
       # filename = here("figs/overlay_weights_fig/raster_fig.png"),
       filename = here("figs/reproduce-test/overlay_weights_fig/raster_fig.png"),
       width = 5,
       height = 5,
       units = "in")
```
...
ggsave(resamp_sec_weights_fig,
       ...
       filename = here("figs/reproduce-test/overlay_weights_fig/perc_coverage_sweight.png"),
       width = 5,
       height = 5,
       units = "in")
ggsave(resamp_sec_weights_fig,
       # filename = here("figs/overlay_weights_fig/perc_coverage_sweight.pdf"),
       filename = here("figs/reproduce-test/overlay_weights_fig/perc_coverage_sweight.pdf"),
       width = 5,
       height = 5,
       units = "in")
```
...
ggsave(admin_region_fig,
       ...
       filename = here("figs/reproduce-test/overlay_weights_fig/admin_region_fig.png"),
       width = 5,
       height = 5,
       units = "in")
ggsave(admin_region_fig,
       # filename = here("figs/overlay_weights_fig/admin_region_fig.pdf"),
       filename = here("figs/reproduce-test/overlay_weights_fig/admin_region_fig.pdf"),
       width = 5,
       height = 5,
       units = "in")
...
ggsave(weight_area_fig,
       ...
       filename = here("figs/reproduce-test/overlay_weights_fig/weighted_area_fig.png"),
       width = 5,
       height = 5,
       units = "in")
ggsave(weight_area_fig,
       # filename = here("figs/overlay_weights_fig/weighted_area_fig.pdf"),
       filename = here("figs/reproduce-test/overlay_weights_fig/weighted_area_fig.pdf"),
       width = 5,
       height = 5,
       units = "in")
```
...
ggsave(combined_weight_fig,
       ...
       filename = here("figs/reproduce-test/overlay_weights_fig/combined_weight_fig.png"),
       width = 5,
       height = 5,
       units = "in")
ggsave(combined_weight_fig,
       # filename = here("figs/overlay_weights_fig/combined_weight_fig.pdf"),
       filename = here("figs/reproduce-test/overlay_weights_fig/combined_weight_fig.pdf"),
       width = 5,
       height = 5,
       units = "in")
```

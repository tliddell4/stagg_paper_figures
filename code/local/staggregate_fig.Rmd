...
while(i <= 4348){
  ...
  hourly <- hourly + 
    ...
    # geom_sf(data = a %>% rotate_data(y_add = y_int*i), mapping = aes(fill = value), size = 2, color = NA) +
    geom_sf(data = a, mapping = aes(fill = value), color = NA) +
...
while(i <= 185){
  ...
  daily <- daily + 
    geom_sf(data = box, size = .1, color = "black", fill = "white") +
    # geom_sf(data = a, mapping = aes(fill = value), size = 2, color = "black") +
    geom_sf(data = a, mapping = aes(fill = value), color = NA) +
    geom_sf(data = box, size = 1, color = "black", fill = NA)
...
# Save plot
ggsave(daily_x,
       filename = here("figs/staggregate_fig/daily_stack_x.png"),
       width = 4,
       height = 3,
       units = "in",
       dpi = 300)
...
ggsave(daily_x,
       filename = here("figs/staggregate_fig/daily_stack_x.pdf"),
       width = 4,
       height = 3,
       units = "in",
       dpi = 300)
...
while(i >= 6){
  ...
  monthly_gridded_1 <- monthly_gridded_1 + 
    ...
    geom_sf(data = a, mapping = aes(fill = order_1), color = NA) +
    geom_sf(data = box, size = 1, color = "black", fill = NA)
...
while(i >= 6){
  ...
  monthly_gridded_2 <- monthly_gridded_2 + 
    ...
    geom_sf(data = a, mapping = aes(fill = order_2), color = NA) +
    geom_sf(data = box, size = 1, color = "black", fill = NA)
...
```{r}
monthly_gridded_1 <- monthly_gridded_1 +
  scale_fill_distiller(palette = fill_palette, direction = -1, values = c(0, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 1)) +
  labs(y = "Months",
       x = "x") +
       # x = bquote(X^2)) +
...
ggsave(fig2a,
       filename = here("figs/staggregate_fig/fig2a.png"),
       width = 4,
       height = 2,
       units = "in",
       dpi = 300)
...
ggsave(fig2a,
       filename = here("figs/staggregate_fig/fig2a.pdf"),
       width = 4,
       height = 2,
       units = "in",
       dpi = 300)
...
ggsave(fig2b,
       filename = here("figs/staggregate_fig/fig2b.png"),
       width = 4,
       height = 2,
       units = "in",
       dpi = 300)
...
ggsave(fig2b,
       filename = here("figs/staggregate_fig/fig2b.pdf"),
       width = 4,
       height = 2,
       units = "in",
       dpi = 300)
...
ggsave(fig2c,
       filename = here("figs/staggregate_fig/fig2c.png"),
       width = 8,
       height = 2,
       units = "in",
       dpi = 300)
...
ggsave(fig2c,
       filename = here("figs/staggregate_fig/fig2c.pdf"),
       width = 8,
       height = 2,
       units = "in",
       dpi = 300)
...
ggsave(fig2,
       filename = here("figs/staggregate_fig/fig2.png"),
       width = 8,
       height = 4,
       units = "in",
       dpi = 300)
...
ggsave(fig2,
       filename = here("figs/staggregate_fig/fig2.pdf"),
       width = 8,
       height = 4,
       units = "in",
       dpi = 300)

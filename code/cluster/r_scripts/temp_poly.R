...
## save outputs
save_name <- paste0(paste("temp", "polynomial", year_start, year_end, "US", "counties", "ERA5",
                          "pop_weights", sep="_"), ".csv")


output_save_path <- "/home/tliddell/stagg_paper_figures/data/stagg_output/temperature/polynomial"
## save message
